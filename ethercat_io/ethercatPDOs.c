...
const ec_pdo_info_t slave_0_pdos[] = {
	...
	/*{0x1600, 2, slave_0_pdo_entries},
	{0x1a00, 2, slave_0_pdo_entries2},*/
};
...
const ec_sync_info_t slave_0_sync[] = {
	...
	{2, EC_DIR_OUTPUT, 1, &slave_0_pdos[0]/*slave_0_pdos + 0*/, EC_WD_DISABLE},
	{3, EC_DIR_INPUT, 1, &slave_0_pdos2[0]/*slave_0_pdos + 1*/, EC_WD_DISABLE},
	{0xff}
};
...
ec_pdo_entry_reg_t domain_regs[] = {
	...
	//{0, 0, 0x00000b95, 0x00001500, 0x7000, 0x02, &off_do2, NULL},
	{0, 0, 0x00000b95, 0x00001500, 0x6000, 0x00, &off_di, NULL},
	//{0, 0, 0x00000b95, 0x00001500, 0x6000, 0x02, &off_di2, NULL},
	{}
};
